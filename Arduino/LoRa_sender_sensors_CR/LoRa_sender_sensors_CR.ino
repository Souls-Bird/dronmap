...
*/
  //We wait on average 2.5 sec or exactly 2.3 sec before sending the next packet, including a random drift to prevent consecutive packet collision
